...
import { UpdateActivityCategoryIconUseCase } from "../updateActivityCategoryIcon/UpdateActivityCategoryIconUseCase";

class UpdateActivityIconController {
...
export { UpdateActivityIconController };
